...
namespace BLL.Services
{
    public class AssignmentService
    {
        ...
        public static void Create(AssignmentDTO c)
        {
            ...
            var cnv = mapper.Map<Assignment>(c);
            DataAccessFactory.AssignmentData().Create(cnv);
            // new ConvocationRepo().RegistrationConvocation(cnv);
        }

        public static List<AssignmentDTO> Show()
        {
            var data = DataAccessFactory.AssignmentData().Show();
        ...
        public static AssignmentDTO Show(int id)
        {
            var data = DataAccessFactory.AssignmentData().Show(id);
            var cfg = new MapperConfiguration(c =>
            {
                c.CreateMap<Assignment, AssignmentDTO>();
            });
        ...
        public static bool Update(AssignmentDTO studentDTO)
        {
            ...
            var mapper = new Mapper(cfg);
            var student = mapper.Map<Assignment>(studentDTO);

            // Call the data access layer to update the student
            var success = DataAccessFactory.AssignmentData().Update(student);
            return success;
        }
        /*
