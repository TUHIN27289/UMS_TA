...
namespace BLL.Services
{
    public class CourseService
    {
        ...
        public static void Create(CourseDTO c)
        {
            ...
            var cnv = mapper.Map<Course>(c);
            DataAccessFactory.CourseData().Create(cnv);
            // new ConvocationRepo().RegistrationConvocation(cnv);
        }

        public static List<CourseDTO> Show()
        {
            var data = DataAccessFactory.CourseData().Show();
        ...
        public static CourseDTO Show(int id)
        {
            var data = DataAccessFactory.CourseData().Show(id);
            var cfg = new MapperConfiguration(c =>
            {
                c.CreateMap<Course, CourseDTO>();
            });
        ...
        public static bool Update(CourseDTO studentDTO)
        {
            ...
            var mapper = new Mapper(cfg);
            var student = mapper.Map<Course>(studentDTO);

            // Call the data access layer to update the student
            var success = DataAccessFactory.CourseData().Update(student);
            return success;
        }
        /*
